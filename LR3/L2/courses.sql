...
--
-- Хост: 127.0.0.1
-- Время создания: Сен 27 2021 г., 20:33
...
INSERT INTO `courses` (`id`, `img_path`, `name`, `id-teacher-type`, `program`, `cost`) VALUES
...
--
ALTER TABLE `courses`
  ADD CONSTRAINT `foreign_key_1` FOREIGN KEY (`id-teacher-type`) REFERENCES `teachers_types` (`id`);
COMMIT;
